...
path <- '/home/cujoisa/Documents/GitHub/kinomescan_viability_prediction/data/LINCS/Data_Files/Kd'
...
if (length(csv_files) == 0) {
  ...
  LINCS_KINOMEscan_Kd <- map_df(csv_files, read_csv)
}

write_csv(LINCS_KINOMEscan_Kd, here('results/LINCS_KINOMEscan_Kd.csv'))
