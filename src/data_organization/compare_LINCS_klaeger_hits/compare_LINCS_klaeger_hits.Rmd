...
matched_drug_data %>%
	...
	labs(title = 
			 	paste0('Klaeger vs Kinomescan Correlation at 1 uM (',
			 				 round(
			 				 	cor(
...
ggsave(here('figures/klaeger_LINCS_correlation.png'), height = 7, width = 7)
```
...
LINCS_klaeger_comparative_data %>%
	...
	labs(
		title = paste0(
		"Klaeger and Kinomescan agreement heatmap, percent agreement = ", round(
			LINCS_klaeger_comparative_data %>% 
	summarise(mean(hit_agreement)),
	3)),
		x = "Kinase",
		y = "Drug")
ggsave(here('figures/klaeger_LINCS_heatmap.png'), width = 15, height = 4)
