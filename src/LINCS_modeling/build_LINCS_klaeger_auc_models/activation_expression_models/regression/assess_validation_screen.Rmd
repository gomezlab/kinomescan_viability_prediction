...
write_csv(validation_summaries, here('results/validation_results/combined_validation_screen_results.csv'))
```
...
ggsave(here('figures/PRISM_LINCS_klaeger/validation/individual_cell_line_validation_assessment.png'), height = 10, width = 19, units = "cm")
