...
args = data.frame(feature_num = c(4000))
...
write_csv(all_metrics, 
					here('results/PRISM_LINCS_klaeger_models_auc/activation_expression/regression/keras/final_keras_cv_metrics.csv')
					)
write_rds(all_predictions, 
					here('results/PRISM_LINCS_klaeger_models_auc/activation_expression/regression/keras/final_keras_cv_predictions.rds.gz'),
					compress = "gz"
)
