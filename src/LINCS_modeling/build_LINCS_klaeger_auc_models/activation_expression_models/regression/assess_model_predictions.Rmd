...
full_plot = plot_grid(full_kinobeads_plot, full_kinomescan_plot , full_overlap_plot, ncol = 2) 
...
for (this_line in unique(BC_predictions$stripped_cell_line_name)) {
	...
	ggsave(here('figures/PRISM_LINCS_klaeger/final_keras_model//BC_lines_predictions/',paste0(this_line,".png")), this_plot, width=16,height=10)
}
```