...
write_csv(model_metrics_combined, here('results/PRISM_LINCS_klaeger_models_auc_regression_metrics.csv'))
```

```{r}
model_metrics_combined = read_csv(here('results/PRISM_LINCS_klaeger_models_auc_regression_metrics.csv'))
# metrics figure
