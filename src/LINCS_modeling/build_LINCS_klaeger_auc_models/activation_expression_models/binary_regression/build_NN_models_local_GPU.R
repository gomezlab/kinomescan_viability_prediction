...
dir.create(here('results/PRISM_LINCS_klaeger_models_auc/activation_expression/binary_regression/NN/results'), 
					 showWarnings = F, recursive = T)
dir.create(here('results/PRISM_LINCS_klaeger_models_auc/activation_expression/binary_regression/NN/predictions'), 
					 showWarnings = F, recursive = T)

full_output_file = here('results/PRISM_LINCS_klaeger_models_auc/activation_expression/binary_regression/NN/results', 
												sprintf('%dfeat.rds.gz',args$feature_num[i]))

pred_output_file = here('results/PRISM_LINCS_klaeger_models_auc/activation_expression/binary_regression/NN/predictions', 
												sprintf('%dfeat.rds.gz',args$feature_num[i]))
