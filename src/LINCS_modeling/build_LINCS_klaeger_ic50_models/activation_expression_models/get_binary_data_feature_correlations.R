...
binary_data = read_rds(here('results/PRISM_LINCS_klaeger_models_ic50/PRISM_LINCS_klaeger_binary_data_for_ml_ic50.rds.gz'))
...
write_csv(binary_feat_cors, here('results/PRISM_LINCS_klaeger_binary_data_feature_correlations_ic50.csv'))
write_csv(variable_kinases, here('results/PRISM_LINCS_klaeger_binary_data_variable_kinases_ic50.csv'))
