...
# 		here('results/PRISM_LINCS_klaeger_models_ic50/activation_expression/binary_regression/rand_forest/results',
...
for (feature_number in c(1,100,200,300)) {
	this_model_results = read_rds(
		here('results/PRISM_LINCS_klaeger_models_ic50/activation_expression/binary_regression/xgboost/results',
				 sprintf('%dfeat.rds.gz',feature_number)))
...
# 	this_model_results = read_rds(
# 		here('results/PRISM_LINCS_klaeger_models_ic50/activation_expression/binary_regression/lr/results',
# 				 sprintf('%dfeat.rds.gz',feature_number)))
# 
...
# for (feature_number in c(100,200,300,400,500,1000,1500,2000,3000,4000,5000)) {
# 	this_model_results = read_rds(
# 		here('results/PRISM_LINCS_klaeger_models_ic50/activation_expression/binary_regression/NN/results',
# 				 sprintf('%dfeat.rds.gz',feature_number)))
# 
# 	this_model_metrics = collect_metrics(this_model_results) %>%
# 		arrange(desc(mean)) %>%
...
# write_csv(all_model_metrics, here('results/PRISM_LINCS_klaeger_models_ic50/activation_expression/binary_regression/all_model_metrics.csv'))
...
# write_csv(model_metrics_combined, here('results/PRISM_LINCS_klaeger_ic50_models_ic50_regression_metrics.csv'))
```

```{r}
#model_metrics_combined = read_csv(here('results/PRISM_LINCS_klaeger_ic50_models_ic50_regression_metrics.csv'))
...
ggsave(here('figures/PRISM_LINCS_klaeger/xgboost_lr_rf_all_data_regression_models_ic50_metrics.png'))
...
dataset_with_rownumbers = this_dataset %>% 
	...
	select(-klaeger_name, -LINCS_name, -ic50) 
