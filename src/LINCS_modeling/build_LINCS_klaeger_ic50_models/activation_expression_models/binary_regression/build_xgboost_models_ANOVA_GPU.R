...
dir.create(here('results/PRISM_LINCS_klaeger_models_ic50/activation_expression/binary_regression/', 
...
full_output_file = here('results/PRISM_LINCS_klaeger_models_ic50/activation_expression/binary_regression/xgboost/results', 
												sprintf('%dfeat.rds.gz',args$feature_num))

pred_output_file = here('results/PRISM_LINCS_klaeger_models_ic50/activation_expression/binary_regression/xgboost/predictions', 
												sprintf('%dfeat.rds.gz',args$feature_num))
...
folds = read_rds(here('results/cv_folds/PRISM_LINCS_klaeger_binary_folds_ic50.rds.gz'))
