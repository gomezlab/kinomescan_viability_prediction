...
ggsave(here('figures/PRISM_LINCS_klaeger/keras_predictions_top_kinase_targets_per_disease_ic50.png'), width = 8, height = 6)
...
full_plot = plot_grid(full_kinobeads_plot, full_kinomescan_plot, ncol = 2) 
...
for (this_line in unique(BC_predictions$stripped_cell_line_name)) {
	...
	ggsave(here('figures/PRISM_LINCS_klaeger/final_keras_model//BC_lines_predictions/',paste0(this_line,".png")), this_plot, width=16,height=5)
}
```