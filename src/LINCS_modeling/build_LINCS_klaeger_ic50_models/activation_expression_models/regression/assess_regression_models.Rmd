...
model_metrics_combined %>% 
  ...
  geom_errorbar(aes(ymin=mean-std_err, ymax=mean+std_err), width=.2,
	...
	labs(title = "LINCS-Klaeger Single Dose models predicting IC50", x = "number of features", y = "R-Squared") +
	facet_wrap(vars(model_type)) 

ggsave(here('figures/PRISM_LINCS_klaeger/all_regression_models_metrics_ic50.png'), width = 10, height = 5)
```
