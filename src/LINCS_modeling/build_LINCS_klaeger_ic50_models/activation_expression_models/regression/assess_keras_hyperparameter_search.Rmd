...
for (feature_number in c(100,200,300,400,500,1000,1500,2000,3000,4000,5000)) {
	this_keras_scores = read_csv(
		here('results/PRISM_LINCS_klaeger_models_ic50/activation_expression/regression/keras/results/kevin_tuning_results',
...
write_csv(best_keras_scores, here('results/PRISM_LINCS_klaeger_models_ic50/activation_expression/regression/keras/results/kevin_best_hyperparameter_search_metrics.csv'))
```
...
for (feature_number in c(100,200,300,400)) {
	
	for (layer in layers) {
		this_keras_scores = read_csv(
			here('results/PRISM_LINCS_klaeger_models_ic50/activation_expression/regression/keras/results',layer,
...
write_csv(combined_all_keras_scores, here('results/PRISM_LINCS_klaeger_models_ic50/activation_expression/regression/keras/results/hyperparameter_search_metrics.csv'))
write_csv(combined_best_keras_scores, here('results/PRISM_LINCS_klaeger_models_ic50/activation_expression/regression/keras/results/best_hyperparameter_search_metrics.csv'))
```
...
for (feature_number in c(100,200,300,400,500)) {
	...
	for (layer in layers) {
		this_keras_scores = read_csv(
			here('results/PRISM_LINCS_klaeger_models_ic50/all_datasets/regression/keras/results',layer,
					sprintf('%dfeat.csv',feature_number))) %>% 
...
write_csv(all_data_combined_all_keras_scores, here('results/PRISM_LINCS_klaeger_models_ic50/all_datasets/regression/keras/results/hyperparameter_search_metrics.csv'))
write_csv(all_data_combined_best_keras_scores, here('results/PRISM_LINCS_klaeger_models_ic50/all_datasets/regression/keras/results/best_hyperparameter_search_metrics.csv'))
```
