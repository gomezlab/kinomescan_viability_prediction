...
```{r}
all_metrics = read_csv(here("results/PRISM_LINCS_klaeger_models_ic50/activation_expression/regression/keras/final_keras_cv_metrics.csv"))
all_predictions = read_rds(here("results/PRISM_LINCS_klaeger_models_ic50/activation_expression/regression/keras/final_keras_cv_predictions.rds.gz"))
```
...
ggsave(here('figures/PRISM_LINCS_klaeger/final_keras_CV_results_ic50.png'), width = 7, height = 10.5, units = "cm")
```
