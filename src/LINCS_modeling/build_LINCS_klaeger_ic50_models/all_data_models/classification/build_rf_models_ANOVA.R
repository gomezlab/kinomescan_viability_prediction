...
full_output_file = here('results/PRISM_LINCS_klaeger_models/all_datasets/classification/rand_forest/results', 
												sprintf('%dfeat.rds',args$feature_num))

pred_output_file = here('results/PRISM_LINCS_klaeger_models/all_datasets/classification/rand_forest/predictions', 
												sprintf('%dfeat.rds',args$feature_num))
