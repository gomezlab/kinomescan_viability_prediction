...
```{r}
full_model_data_set_5000feat <- read_rds(here('results/PRISM_LINCS_klaeger_models_auc/PRISM_LINCS_klaeger_data_for_ml_5000feat_auc.rds.gz'))
...
write_rds(model_features,here('results/PRISM_LINCS_klaeger_models_auc/expression_feature_interactors.rds'))
```
