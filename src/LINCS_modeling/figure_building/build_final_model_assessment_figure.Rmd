...
combined_metrics %>%
	mutate(
		...
		"Inhibition and Expression only",
		"All Multi-Omics"
	),
		model_type = if_else(
  ...
  #                position=position_dodge(.9)) +
	...
	labs(x = "number of features", y = "R-squared", colour = "Model Type", shape = "Model Type") +
		theme(
...
ggsave(here('figures/PRISM_LINCS_klaeger/all_regression_model_metrics.png'), height = 10.5, width = 14, units = "cm")
```
