...
exp_interactor_type = read_rds(here('results/PRISM_LINCS_klaeger_models_ic50/expression_feature_interactors.rds')) %>%
...
feats_list.append('ic50')
ids = ['broad_id','ccle_name','depmap_id','ic50_binary']
#add ids to feats_list
feats_list.extend(ids)
data = data[feats_list]
exclude = ['ic50','broad_id','ccle_name','depmap_id','ic50_binary']
y = data['ic50']
...
shap_values_processed = shap_values %>% 
	...
	write_csv(here('results/PRISM_LINCS_klaeger_models_ic50/all_feature_shap_values.csv'))
```

```{r}
#separate by feature type and plot 
shap_values_processed = read_csv(here('results/PRISM_LINCS_klaeger_models_ic50/all_feature_shap_values.csv'))
