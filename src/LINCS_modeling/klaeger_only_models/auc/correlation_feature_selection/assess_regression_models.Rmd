...
for (feature_number in c(100,200,300,400,500,1000,1500,2000,3000,4000,5000)) {
	this_model_results = read_rds(
		here('results/klaeger_only_models_auc/activation_expression/regression/rand_forest/results',
...
for (feature_number in c(100,200,300,400,500,1000,1500,2000,3000,4000,5000)) {
	this_model_results = read_rds(
		here('results/klaeger_only_models_auc/activation_expression/regression/xgboost/results',
				 sprintf('%dfeat.rds.gz',feature_number)))
...
for (feature_number in c(100,200,300,400,500,1000,1500,2000)) {
	this_model_results = read_rds(
		here('results/klaeger_only_models_auc/activation_expression/regression/lr/results',
				 sprintf('%dfeat.rds.gz',feature_number)))
...
for (feature_number in c(100)) {
	this_model_results = read_rds(
		here('results/klaeger_only_models_auc/activation_expression/regression/NN/results',
				 sprintf('%dfeat.rds.gz',feature_number)))
...
write_csv(all_model_metrics, here('results/klaeger_only_models_auc/activation_expression/regression/all_model_metrics.csv'))
...
for (feature_number in c(100,200,300,400,500,1000,1500,2000,3000)) {
	this_model_results = read_rds(
		here('results/klaeger_only_models_auc/all_datasets/regression/lr/results',
				 sprintf('%dfeat.rds.gz',feature_number)))
...
for (feature_number in c(100,200,300,400,500,1000,1500,2000,3000,4000,5000)) {
	this_model_results = read_rds(
		here('results/klaeger_only_models_auc/all_datasets/regression/rand_forest/results',
				 sprintf('%dfeat.rds.gz',feature_number)))
...
for (feature_number in c(100,200,300,400,500,1000,1500,2000,3000,4000,5000)) {
	this_model_results = read_rds(
		here('results/klaeger_only_models_auc/all_datasets/regression/xgboost/results',
				 sprintf('%dfeat.rds.gz',feature_number)))
...
for (feature_number in c(100,200,300,400,500,1000,1500,2000,3000,4000,5000)) {
	this_model_results = read_rds(
		here('results/klaeger_only_models_auc/all_datasets/regression/NN/results',
				 sprintf('%dfeat.rds.gz',feature_number)))
...
write_csv(all_model_all_data_metrics, here('results/klaeger_only_models_auc/all_datasets/regression/all_model_metrics.csv'))
```
...
```{r}
all_model_metrics = read_csv(here('results/klaeger_only_models_auc/activation_expression/regression/all_model_metrics.csv'))
all_model_all_data_metrics = data.frame()
#read_csv(here('results/klaeger_only_models_auc/all_datasets/regression/all_model_metrics.csv'))

model_metrics_combined = all_model_all_data_metrics %>% 
	bind_rows(all_model_metrics)

write_csv(model_metrics_combined, here('results/klaeger_only_models_auc_regression_metrics.csv'))
```

```{r}
model_metrics_combined = read_csv(here('results/klaeger_only_models_auc_regression_metrics.csv'))
# metrics figure
...
ggsave(here('figures/klaeger_only_models_auc/all_regression_models_metrics.png'))
