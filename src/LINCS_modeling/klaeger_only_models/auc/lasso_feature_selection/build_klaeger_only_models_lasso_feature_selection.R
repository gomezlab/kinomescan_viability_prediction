...
get_recipe = function(data, feature_number) {
...
recipe_600 = get_recipe(data = this_dataset, feature_number = 600)
recipe_700 = get_recipe(data = this_dataset, feature_number = 700)
recipe_809 = get_recipe(data = this_dataset, feature_number = 809)
