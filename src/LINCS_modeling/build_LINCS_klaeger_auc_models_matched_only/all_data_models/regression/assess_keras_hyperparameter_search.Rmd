...
write_csv(combined_all_keras_scores, here('results/PRISM_LINCS_klaeger_models_auc/all_datasets/regression/keras/results/hyperparameter_search_metrics.csv'))
write_csv(combined_best_keras_scores, here('results/PRISM_LINCS_klaeger_models_auc/all_datasets/regression/keras/results/best_hyperparameter_search_metrics.csv'))
```
