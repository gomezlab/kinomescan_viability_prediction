...
for (feature_number in c(100,200,300,400,500,1000,1500,2000,3000,4000,5000)) {
	this_model_results = read_rds(
		here('results/PRISM_LINCS_klaeger_models_auc/matched_only_models/activation_expression/regression/rand_forest/results',
...
for (feature_number in c(100,200,300,400,500,1000,1500,2000,3000,4000)) {
	this_model_results = read_rds(
		here('results/PRISM_LINCS_klaeger_models_auc/matched_only_models/activation_expression/regression/xgboost/results',
				 sprintf('%dfeat.rds.gz',feature_number)))
...
for (feature_number in c(100,200,300,400,500,1000,1500,2000,3000,4000,5000)) {
	this_model_results = read_rds(
		here('results/PRISM_LINCS_klaeger_models_auc/matched_only_models/activation_expression/regression/lr/results',
				 sprintf('%dfeat.rds.gz',feature_number)))
...
write_csv(all_model_metrics, here('results/PRISM_LINCS_klaeger_models_auc/matched_only_models/activation_expression/regression/all_model_metrics.csv'))
toc()
