...
model_predictions = read_csv(here('results/PRISM_LINCS_klaeger_models_auc/matched_only_models/final_model_predictions_xgboost.csv')) 
...
rsq = cor(replication_comparison$auc, replication_comparison$exp_auc)^2
...
ggsave(here('figures/PRISM_LINCS_klaeger/matched_only_models/validation/preliminary_replication_assessment.png'), height = 10, width = 9.5, units = "cm")
```
...
ggsave(here('figures/PRISM_LINCS_klaeger/matched_only_models/validation/preliminary_validation_assessment.png'), height = 10, width = 9.5, units = "cm")
```
