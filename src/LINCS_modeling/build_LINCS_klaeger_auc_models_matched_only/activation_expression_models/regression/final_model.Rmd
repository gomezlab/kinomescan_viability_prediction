...
model_metrics_combined = read_csv(here('results/PRISM_LINCS_klaeger_models_auc/matched_only_models/activation_expression/regression/all_model_metrics.csv')) %>% 
...
results = this_wflow %>% 
	...
	write_rds(here('results/PRISM_LINCS_klaeger_models_auc/matched_only_models/activation_expression/regression/xgboost/final_xgboost_model.rds.gz'), compress = "gz")
```
...
not_tested_data = non_tested_combos %>%
	...
	left_join(CCLE_data %>% 
							select(depmap_id,
										 any_of(names(this_dataset))),
						by = 'depmap_id') %>% 
	write_rds(here('results/PRISM_LINCS_klaeger_models_auc/matched_only_models/activation_expression/regression/not_tested_data_xgboost.rds.gz'), compress = "gz")
...
model_predictions_tidy = model_predictions %>%
	...
	write_csv(here('results/PRISM_LINCS_klaeger_models_auc/matched_only_models/final_model_predictions_xgboost.csv'))
```