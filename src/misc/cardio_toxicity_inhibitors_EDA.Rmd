...
heatmap_plot = cardio_toxicity_data_long %>% 
...
combined = heatmap_plot + dendro_plot + plot_layout(widths = c(1,2))

ggsave(here('figures/cardio_toxicity/heatmap_hclust.png'))
```
