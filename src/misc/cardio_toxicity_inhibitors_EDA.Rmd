...
ggsave(here('figures/cardio_toxicity/dendro_plot.png'), width = 4.5, height = 16.35, units = "cm")
...
ggsave(here('figures/cardio_toxicity/target_heatmap.png'), width = 21, height = 17.34, units = "cm")
```

```{r}
#target-based heirarchichal clustering
...
# Create dendro
dendro_plot <- ggdendrogram(data = matrix_dendro, rotate = TRUE)
ggsave(here('figures/cardio_toxicity/target_dendro_plot.png'), width = 4.5, height = 16.35, units = "cm")
...
ggsave(here('figures/cardio_toxicity/target_event_heatmap.png'), width = 4, height = 21, units = "cm")
...
ggsave(here('figures/cardio_toxicity/target_target_heatmap.png'), width = 21, height = 18.93, units = "cm")
```
