...
cardio_toxicity_data_processed = cardio_toxicity_data %>% 
		bind_rows(data.frame(drug = c("Erlotinib"),
												 QT_interval_prolongation = 1,
												 LV_dysfuntion = 1,
												 HF = 1,
												 Arrhythmia = 1,
												 Ischemia_or_MI = 1, Hypertension = 1
											 )) %>% 
