...
umap_df %>%
  ...
  labs(x = "UMAP1",
	...
	ggsave(here("figures/clustering/klaeger_kinomescan_UMAP_matched_kinases_only.png"), width = 14.816, height = 5.258, units = "cm")
```
...
umap_with_outcome %>%
  ...
  labs(x = "UMAP1",
	...
	ggsave(here("figures/clustering/klaeger_kinomescan_UMAP_by_outcome_matched_kinases_only.png"), width = 20, height = 10, units = "cm")
```
